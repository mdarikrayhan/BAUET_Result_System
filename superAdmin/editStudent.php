                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="matricNo" type="text" class="form-control cc-exp" value="<?php echo $rowi['matricNo'];?>" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Student ID">
                                                    </div>
                                                </div>
                                            <div class="col-6">
                                                <div class="form-group">
