...
if($result=mysqli_query($connection,$sql)){
 ...
 $query =  "SELECT po_per, count(*) as number FROM po_attainment  WHERE 
 ...
 <html>  
      <head>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["po_per"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: 'Percentage of PO',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
      ...
      <body>  
           ...
           <div style="width:900px;">  
				<h3 align="center">PO Attainment Graph</h3>  
				<div id='go_back' style="width: 100px; height: 30px;">
				<a href="po_att.php?value=<?php echo $id;?>">Go Back</a>
				</div> 
                <br />  
