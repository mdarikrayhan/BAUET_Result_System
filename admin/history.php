	...
	<div class="mainContent">
		...
		<center>
		    ...
		    if($result=mysqli_query($connection,$sql)){
		        ...
		        $sql1="SELECT * FROM student where course_code='$course_code'";	//see all the students who r enrolled under sepcific Instructor!
...
if(isset($_POST['add_1'])){
	   ...
	   // $sql1="SELECT * FROM student where course_code='$course_code'";
		$sql6="SELECT * FROM student where s_id='$select_id' AND grade IS NULL ";
	 ...
	 echo "<table class='table_1'border='1'>";
			...
			echo "</tr>";
	   	 	...
	   	 	$sql6="SELECT * FROM student where s_id='$select_id' AND grade IS NOT NULL";
		    if($result6=mysqli_query($connection,$sql6)){
			    if(mysqli_num_rows($result6)>0){
		        	while ($row6 = mysqli_fetch_array($result6)){
		        		$s_id=$row6['s_id'];
